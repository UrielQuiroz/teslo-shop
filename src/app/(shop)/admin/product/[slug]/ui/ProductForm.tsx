            ...
            
            {
              sizes.map( size => (
                ...
                <div 
                  ...
                  className={
                    clsx(
                      "p-2 border rounded-md hover:bg-gray-100 cursor-pointer mr-2 mb-2 w-14 transition-all text-center",
                      {
                        'bg-blue-500 hover:bg-blue-600 text-white': getValues('sizes').includes(size)
                      }
                    )
                  }>
                  <span>{ size }</span>
